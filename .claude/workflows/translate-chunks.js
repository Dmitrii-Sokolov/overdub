...
Follow the contract file's rules exactly. Three of them decide most of the outcome:
  - BOTH FORMS, inline: [[written|spoken]]. Every brand, product, code identifier, file name and
    ...
    Contract rules 5-6 carry the spellings and the limits. Your chunk shares its terminology with
    the neighbours, so keep ONE spoken spelling per name across the whole video — that is the
    first thing to copy out of the previous chunk.
