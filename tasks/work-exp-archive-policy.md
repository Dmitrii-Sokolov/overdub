...
- [ ] Classify; protect the 2026-07-21 wave baselines.
...
The scout-era wave baselines under `work-exp/wave-*-2026-07-21/` are live (the route itself was
deleted 2026-08-24, the measurement cells remain) — **a re-run of that 6-video queue overwrites
the artifacts, so copy the six `scout.json` before repeating it.**
